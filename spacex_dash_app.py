...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df=filtered_df.groupby(["Launch Site","class"]).size().rename("count")
...
def get_scatter_plot(entered_site,slider_range):
    ...
    if entered_site == 'ALL':
        ...
        new_df=spacex_df[["Launch Site","class","Payload Mass (kg)","Booster Version Category"]]
        new_df=new_df.groupby(["Payload Mass (kg)", "Launch Site","class"]).first().reset_index()
        new_df=new_df.loc[new_df['Launch Site'] == entered_site]
